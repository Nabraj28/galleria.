...
const useGetArtWorks = (url?: string) => {
    ...
    const endpoint = url || `/artworks?limit=24&fields=id,title,description,artist_title,date_end,publication_history,exhibition_history,provenance_text,image_id`;
